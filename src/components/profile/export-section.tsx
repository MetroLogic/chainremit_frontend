        ...
        <CardContent className="space-y-4 lg:space-y-6">
          {exportItems.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="p-3 lg:p-4 border rounded-lg space-y-4"
              >
      ...
      <Card className="border-gray-200 dark:border-gray-800">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-3">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 border rounded-lg space-y-3 sm:space-y-0">
