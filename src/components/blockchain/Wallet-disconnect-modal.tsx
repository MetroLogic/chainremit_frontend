      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          >
            <button
              onClick={onClose}
              className="flex justify-center float-end text-gray-400 hover:text-white transition-colors mb-3"
            >
              <X size={20} />
            </button>
            <div className="flex items-center justify-between mb-8 px-10">
              <h2 className="text-xl flex justify-center text-center font-semibold text-white mt-5 pl-10">
                Disconnect Wallet
              </h2>
            </div>
            ...
            <div className="flex justify-between gap-2 mt-8">
              ...
              <button
                className=" py-3 w-full text-center cursor-pointer rounded-[48px] bg-blue-500 text-white font-medium hover:bg-blue-600 transition-colors"
