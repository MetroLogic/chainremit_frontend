          ...
          <Card className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20">
            <CardContent className="p-6 text-center space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Securely connect your wallet to access all StarkRemit features
              </p>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="p-2 border rounded bg-gray-50 dark:bg-gray-800">alice.stark</div>
                </div>
                <div>
                  <label className="text-sm font-medium">Amount</label>
                  <div className="p-2 border rounded bg-gray-50 dark:bg-gray-800">$125.50</div>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">Excellent Credit</p>
              </div>
            </CardContent>
          </Card>
        )
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      <header className="border-b bg-white/80 backdrop-blur-sm dark:bg-gray-900/80">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold">StarkRemit Demo</span>
          </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4">Experience StarkRemit</h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Take an interactive tour of our decentralized finance platform and see how easy it is to send money, save
            with groups, and access microloans.
          </p>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Click on any step to explore that feature</CardDescription>
                </CardHeader>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardDescription>Send money globally with minimal fees and instant settlement</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardDescription>Join community savings circles with automated payouts</CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center">
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardDescription>Access small loans based on your credit score</CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center">
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              {demoSteps.map((step, index) => (
                <Card key={index} className="overflow-hidden">
                  ...
                  <CardContent className="p-6">{renderDemoComponent(step.component)}</CardContent>
                </Card>
              ))}
            </div>
          </TabsContent>
          ...
          <Card className="max-w-2xl mx-auto bg-gradient-to-r from-blue-600 to-purple-600 text-white border-0">
            <CardContent className="p-8">
              ...
              <p className="mb-6 opacity-90">
                Join thousands of users who are already using StarkRemit for their financial needs.
              </p>
